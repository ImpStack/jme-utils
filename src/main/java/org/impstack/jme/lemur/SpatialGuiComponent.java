...
/**
 * A Lemur GuiComponent that can hold a spatial.
 * A GuiComponent can be set as an icon or as a background of other Lemur components.
 *
 * The size of the spatial in screen pixels can be set using {@link SpatialGuiComponent#setSpatialSize(Vector3f)}
 * @author remy
 * @since 13/03/18
 */
public class SpatialGuiComponent extends AbstractGuiComponent {
    ...
    public SpatialGuiComponent(Spatial spatial) {
        this(spatial, new Vector3f());
    }

    public SpatialGuiComponent(Spatial spatial, Vector3f spatialSize) {
